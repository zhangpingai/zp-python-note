...
![image.png](assets/05_Python数据容器/file-20260530130637409.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637436.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637466.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637488.png)

## 嵌套列表的定义

![image.png](assets/05_Python数据容器/file-20260530130637519.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637554.png)

如图，列表中的每一个元素，都有其位置下标索引，从前向后的方向，从0开始，依次递增

我们只需要按照下标索引，即可取得对应位置的元素。

![image.png](assets/05_Python数据容器/file-20260530130637586.png)

## 列表的下标（索引） - 反向

或者，可以反向索引，也就是从后向前：从-1开始，依次递减（-1、-2、-3......）

![image.png](assets/05_Python数据容器/file-20260530130637607.png)

如图，从后向前，下标索引为：-1、-2、-3，依次递减。

![image.png](assets/05_Python数据容器/file-20260530130637628.png)

## 嵌套列表的下标（索引）

如果列表是嵌套的列表，同样支持下标索引

![image.png](assets/05_Python数据容器/file-20260530130637412.png)

如图，下标就有2个层级了。

![image.png](assets/05_Python数据容器/file-20260530130637417.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637405.png)

![image.png](assets/05_Python数据容器/file-20260530130637419.png)

方法和函数功能一样，有传入参数，有返回值，只是方法的使用格式不同：

函数的使用：![image.png](assets/05_Python数据容器/file-20260530130637415.png)

方法的使用：![image.png](assets/05_Python数据容器/file-20260530130637425.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637422.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637430.png)

•插入元素：

语法：列表.insert(下标, 元素)，在指定的下标位置，插入指定的元素

![image.png](assets/05_Python数据容器/file-20260530130637428.png)

•追加元素：

语法：列表.append(元素)，将指定元素，追加到列表的尾部

![image.png](assets/05_Python数据容器/file-20260530130637433.png)

•追加元素方式2：

语法：列表.extend(其它数据容器)，将其它数据容器的内容取出，依次追加到列表尾部

![image.png](assets/05_Python数据容器/file-20260530130637438.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637443.png)

•删除某元素在列表中的第一个匹配项

语法：列表.remove(元素)

![image.png](assets/05_Python数据容器/file-20260530130637446.png)

•清空列表内容，语法：列表.clear()

![image.png](assets/05_Python数据容器/file-20260530130637448.png)

•统计某元素在列表内的数量

语法：列表.count(元素)

![image.png](assets/05_Python数据容器/file-20260530130637441.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637451.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637454.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637457.png)

![image.png](assets/05_Python数据容器/file-20260530130637462.png)

![image.png](assets/05_Python数据容器/file-20260530130637459.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637468.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637471.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637477.png)

  

![image.png](assets/05_Python数据容器/file-20260530130637474.png)

注意：元组只有一个数据，这个数据后面要添加逗号

元组也支持嵌套：

![image.png](assets/05_Python数据容器/file-20260530130637479.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637482.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637486.png)

可以修改元组内的list的内容（修改元素、增加、删除、反转等）

![image.png](assets/05_Python数据容器/file-20260530130637491.png)

不可以替换list为其它list或其它类型

![image.png](assets/05_Python数据容器/file-20260530130637497.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637494.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637503.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637500.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637506.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637508.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637512.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637514.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637516.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637521.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637527.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637524.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637529.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637532.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637534.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637536.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637539.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637544.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637541.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637549.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637546.png)

  

## 集合同样支持使用for循环遍历

![image.png](assets/05_Python数据容器/file-20260530130637551.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637557.png)

Python中字典和生活中字典十分相像：

![image.png](assets/05_Python数据容器/file-20260530130637562.png)

  

老师有一份名单，记录了学生的姓名和考试总成绩。

![image.png](assets/05_Python数据容器/file-20260530130637565.png)

现在需要将其通过Python录入至程序中，并可以通过学生姓名检索学生的成绩。

使用字典最为合适：

![image.png](assets/05_Python数据容器/file-20260530130637560.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637570.png)

前文中提到的，记录学生成绩，可以使用如下定义：

前文中记录学生成绩的需求，可以如下记录：

![image.png](assets/05_Python数据容器/file-20260530130637572.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637576.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637581.png)

代码：

![image.png](assets/05_Python数据容器/file-20260530130637583.png)

优化一下可读性，可以写成：

![image.png](assets/05_Python数据容器/file-20260530130637578.png)

## 嵌套字典的内容获取

嵌套字典的内容获取，如下所示：

![image.png](assets/05_Python数据容器/file-20260530130637589.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637592.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637600.png)

## ​删除元素

语法：字典.pop(Key)，结果：获得指定Key的Value，同时字典被修改，指定Key的数据被删除

![image.png](assets/05_Python数据容器/file-20260530130637595.png)

## ​清空字典

语法：字典.clear()，结果：字典被修改，元素被清空

![image.png](assets/05_Python数据容器/file-20260530130637597.png)

## ​获取全部的key

语法：字典.keys()，结果：得到字典中的全部Key

![image.png](assets/05_Python数据容器/file-20260530130637602.png)

## ​遍历字典

语法：for key in 字典.keys()

![image.png](assets/05_Python数据容器/file-20260530130637605.png)

![image.png](assets/05_Python数据容器/file-20260530130637612.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637610.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637615.png)

运行后，输出如下信息：

![image.png](assets/05_Python数据容器/file-20260530130637618.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637620.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637623.png)
...
![image.png](assets/05_Python数据容器/file-20260530130637631.png)

字符串是按位比较，也就是一位位进行对比，只要有一位大，那么整体就大。

![image.png](assets/05_Python数据容器/file-20260530130637626.png)
