...
![image.png](assets/Python函数/Python函数-1.png)
...
![image.png](assets/Python函数/Python函数-2.png)
...
![image.png](assets/Python函数/Python函数-3.png)
...
![image.png](assets/Python函数/Python函数-4.png)

可以有如下函数定义：

![image.png](assets/Python函数/Python函数-5.png)
...
![image.png](assets/Python函数/Python函数-6.png)
...
![image.png](assets/Python函数/Python函数-7.png)

![image.png](assets/Python函数/Python函数-8.png)
...
![image.png](assets/Python函数/Python函数-9.png)
...
![image.png](assets/Python函数/Python函数-10.png)

None可以主动使用return返回，效果等同于不写return语句：

![image.png](assets/Python函数/Python函数-11.png)
...
![image.png](assets/Python函数/Python函数-12.png)
...
![image.png](assets/Python函数/Python函数-13.png)
...
![image.png](assets/Python函数/Python函数-14.png)
...
![image.png](assets/Python函数/Python函数-15.png)
...
![image.png](assets/Python函数/Python函数-16.png)

执行效果：

![image.png](assets/Python函数/Python函数-17.png)

## 执行过程

![image.png](assets/Python函数/Python函数-18.png)
...
![image.png](assets/Python函数/Python函数-19.png)
...
![image.png](assets/Python函数/Python函数-20.png)
...
![image.png](assets/Python函数/Python函数-21.png)

\`testB\`函数内部的 num = 200 是定义了一个局部变量

☆ 使用 global关键字 可以在函数内部声明变量为全局变量, 如下所示

![image.png](assets/Python函数/Python函数-22.png)
